...
```python
print('hello there %(3)s' % {})  # Error on this line
```
...
```python
print('hello there %(3)s' % {'5': 'you', '3': 'you'})  # Error on this line
```
...
```python
print('{!} is a foobar'.format({'badge_name': 'foo'}))   # Error on this line
```
...
```python
print("{} and {0}".format("a", "b"))  # Error on this line
```
...
```python
print('{.5}'.format('aaabbbccc'))  # Error on this line
```
